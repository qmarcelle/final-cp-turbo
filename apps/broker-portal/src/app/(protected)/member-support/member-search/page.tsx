...
export default function MemberSearchPage() {
  return (
    <div>
      <h1>Member Search</h1>
      <p>
        Use this page to find a member. Once a member is selected, you will be
        taken to their details page.
      </p>
      ...
      <nav aria-labelledby="member-search-navigation">
        ...
        <ul>
          ...
          <li>
            <Link href="/member-support/member-search/example-member-id">
              View Example Member Details
            </Link>
          </li>
        </ul>
      </nav>

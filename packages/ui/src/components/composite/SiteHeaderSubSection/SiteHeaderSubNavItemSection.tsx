...
import { externalIcon, parentPageArrowIcon } from '../../foundation/Icons/Icons';
          ...
          return (
            <>
              ...
              !item.text ? (
               ...
               <TextBox text={item.title} className='font-normal app-base-font-color' /> 
              )
              )}
            </>
          );

...
export const brokerPortalConfig: PortalConfig = {
  ...
  basePath: '/broker',
  logo: {
    full: '/assets/logos/bcbst_blue.svg',
    stacked: '/assets/logos/bcbstn.svg',
    alt: 'BlueCross BlueShield of Tennessee',
  },
  footer: {
    copyrightText:
      '©1998-[YEAR] BlueCross BlueShield of Tennessee, Inc., an Independent Licensee of the Blue Cross Blue Shield Association. BlueCross BlueShield of Tennessee is a Qualified Health Plan issuer in the Health Insurance Marketplace.',

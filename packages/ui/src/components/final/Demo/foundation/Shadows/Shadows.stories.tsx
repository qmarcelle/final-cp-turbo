...
const ShadowDemo = ({ shadow }: { shadow: (typeof shadowLevels)[0] }) => (
  <div className="flex flex-col items-center text-center space-y-3">
    <div
      className={`w-20 h-20 bg-white rounded-lg ${shadow.className} border border-gray-100`}
    />
    <div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Consistent elevation system that creates depth and hierarchy in the
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Shadow transitions for interactive elements that provide visual
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow p-6 transition-shadow hover:shadow-lg cursor-pointer">
            ...
            <p className="text-gray-600 text-sm">
              Hover over this card to see the shadow transition effect. The
              elevation increases to show interactivity.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h4 className="font-semibold text-gray-900 mb-2">Elevated Card</h4>
            <p className="text-gray-600 text-sm">
              This card has a higher default elevation, suitable for important
              content or active states.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative">
            ...
            <p className="text-xs text-gray-500 mt-2">
              Uses shadow-lg for clear separation
            </p>
          </div>
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">
              Uses shadow-2xl for maximum prominence
            </p>
          </div>
        </div>
      </div>
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Best practices for applying shadows to create effective visual
          hierarchy and depth.
        </p>
      </div>
                ...
                <div className="bg-white shadow-lg rounded p-2">
                  <div className="bg-white shadow-md rounded p-2">
                    <div className="bg-white shadow rounded p-2">
                      <p className="text-xs">
                        Nested shadows create visual noise
                      </p>
                    </div>
                  </div>
                </div>
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Real-world examples of how shadows are applied to common broker portal
          components.
        </p>
      </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        ...
        <p className="text-sm text-gray-600 mt-4">
          Standard cards use shadow, hover states use shadow-md, priority
          content uses shadow-md by default.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">
              Subtle shadow-sm for fixed header
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">
              Strong shadow-lg for floating menus
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <p className="text-sm text-gray-600 mt-4">
          Form elements use subtle shadow-sm, focus states may enhance shadow
          slightly.
        </p>
      </div>
    </div>

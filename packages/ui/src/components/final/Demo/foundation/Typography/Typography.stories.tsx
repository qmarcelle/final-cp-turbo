...
const bodyStyles = [
  {
    ...
    size: '18px',
    lineHeight: '28px',
    usage: 'Introduction text, key information',
  },
  {
    name: 'Body Regular',
    className: 'text-base',
...
const fontWeights = [
  {
    ...
    weight: '300',
    usage: 'Rarely used, special emphasis',
  },
  {
    name: 'Regular',
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Consistent heading styles that establish clear information hierarchy
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-gray-600 space-y-1">
          <li>
            • Use heading hierarchy logically (H1 → H2 → H3, don't skip levels)
          </li>
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Text styles for content, supporting information, and user interface
          elements.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        {bodyStyles.map(style => (
          <TypeExample
            ...
            specs={`${style.size} / ${style.lineHeight}`}
          >
            The broker portal provides comprehensive tools for managing health
            insurance sales, commission tracking, and member services. Access
            real-time data and streamlined workflows to enhance your
            productivity and better serve your clients.
          </TypeExample>
        ))}
      </div>
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Font weight variations for emphasis, hierarchy, and visual
          distinction.
        </p>
      </div>
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Typography in context, showing how styles work together in actual
          broker portal interfaces.
        </p>
      </div>
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Ensuring readable and accessible text for all users, including those
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Adequate line spacing (1.5x font size) improves reading
                comprehension and reduces eye strain for users with dyslexia and
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-tight">
                Cramped line spacing makes text difficult to read and can cause
                users to lose their place when reading longer passages.
              </p>
            </div>
            <div>
              <h4 className="text-base font-semibold text-gray-900 mb-2">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base text-gray-700 max-w-3xl">
              On desktop screens, we can use larger text sizes and longer line
              lengths. This allows for more content per line while maintaining
              readability. Optimal line length is 65-75 characters for
              comfortable reading.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <div className="space-y-3 max-w-sm">
            ...
            <p className="text-sm text-gray-700">
              Mobile screens require smaller text sizes and shorter line
              lengths. We prioritize readability and thumb-friendly interaction
              zones.
            </p>
          </div>
        </div>

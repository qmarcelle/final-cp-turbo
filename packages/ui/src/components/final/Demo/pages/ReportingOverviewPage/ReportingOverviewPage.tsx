...
const ReportingOverviewPage = React.forwardRef<HTMLDivElement, ReportingOverviewPageProps>(
  (
    {
      user = {
    ...
    const QuickAccessSidebar = () => (
      <div className="space-y-6">
        <div>
          <h3 className="text-sm font-semibold text-gray-900 mb-4">Report Shortcuts</h3>
        ...
        <div>
          <h4 className="text-sm font-semibold text-gray-900 mb-3">Scheduled Reports</h4>
          <div className="space-y-3">
            ...
            <div className="bg-green-50 p-3 rounded-lg">
              <p className="text-sm font-medium text-green-900">Weekly Activity</p>
              <p className="text-xs text-green-600">Next: Every Monday</p>
            </div>
            <div className="bg-purple-50 p-3 rounded-lg">
              <p className="text-sm font-medium text-purple-900">Quarterly Review</p>
    ...
    const MainContent = () => (
      <div className="space-y-8">
        ...
        <Alert
          ...
          onClose={() => {}}
        >
          New analytics features are now available including trend analysis and predictive insights. 
          <a href="/broker/training/reporting" className="text-blue-600 hover:underline ml-1">
        ...
        <div>
          <h2 className="text-lg font-semibold text-gray-900 mb-6">Reporting Summary</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            />
            <StatBlock
              value={mockReportCategories.reduce((acc, cat) => acc + cat.reportCount, 0)}
                ...
                <Card.Header>
                  <div className="flex items-center gap-3">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                      category.category === 'commission' ? 'bg-green-100' :
                      category.category === 'member' ? 'bg-blue-100' :
                      category.category === 'group' ? 'bg-purple-100' :
                      'bg-orange-100'
                    }`}>
                      <svg className={`w-6 h-6 ${
                        category.category === 'commission' ? 'text-green-600' :
                        category.category === 'member' ? 'text-blue-600' :
                        category.category === 'group' ? 'text-purple-600' :
                        'text-orange-600'

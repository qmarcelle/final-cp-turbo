  ...
  (
    ...
    const isDateDisabled = (date: Date): boolean => {
      ...
      const isNotIncluded =
        ...
        !includeDates.some(
          includeDate =>
            format(date, 'yyyy-MM-dd') === format(includeDate, 'yyyy-MM-dd')
        )
    ...
    return (
      <div ref={ref} className={cn('form-control', className)} data-cy={dataCy}>
        {label && (
          <label
            htmlFor={name}
            className={cn(
...
// Only export Calendar since DatePicker is already exported above
export { Calendar }

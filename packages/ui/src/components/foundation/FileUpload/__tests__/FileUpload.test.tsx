...
describe('FileUpload Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders file restrictions information', () => {
      ...
      expect(screen.getByText('Accepted file types: .pdf,.docx')).toBeInTheDocument();
  ...
  describe('Validation', () => {
    it('validates file type', async () => {
      ...
      const file = createFile('test.docx', 1024, 'application/vnd.openxmlformats-officedocument.wordprocessingml.document');
      const input = document.querySelector('input[type="file"]');
    ...
    it('validates file size', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/File size exceeds 1000 Bytes/)).toBeInTheDocument();
      });
    });
  ...
  describe('Upload Functionality', () => {
    it('calls onUpload when files are added', async () => {
      ...
      await waitFor(() => {
        expect(mockUpload).toHaveBeenCalledWith(expect.arrayContaining([
  ...
  describe('Edge Cases', () => {
    ...
    it('properly formats file sizes', async () => {
      ...
      const largeFile = createFile('large.zip', 1024 * 1024 * 3, 'application/zip');

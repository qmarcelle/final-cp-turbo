...
This package is responsible for handling authentication and authorization logic across all portal applications.

Refer to the main [Enterprise Portal Architecture & Development Standards](../../../README.md) for overall guidelines, particularly the sections on Security Standards.

## Purpose

- Provide a centralized and consistent way to manage user authentication (e.g., login, logout, session management).
...
- Hooks and utilities for accessing user session and roles in Next.js applications (both Server and Client Components).
